...
import com.daiyan.handwork.app.widget.pull.internal.EmptyViewMethodAccessor;
import com.daiyan.handwork.app.widget.pull.internal.LoadingLayout;
...
public class PullToRefreshListView extends PullToRefreshAdapterViewBase<ListView> {
	...
	// 扩展接口：单独修改底部条加载更多提示文字 - 【魏工/2015-05-19】
	public void setLabelFooter(String pullLabel, String releaseLabel,  String refreshingLabel)
	{
		super.setLabelFooter(pullLabel, releaseLabel, refreshingLabel);
		if (null != footerLoadingView) 
		{
			footerLoadingView.setPullLabel(pullLabel);
			footerLoadingView.setReleaseLabel(releaseLabel);
	...
	protected final ListView createRefreshableView(Context context, AttributeSet attrs) {
		...
		if (mode == MODE_PULL_DOWN_TO_REFRESH || mode == MODE_BOTH) {
			...
			lv.addHeaderView(frame, null, false); // 禁止点击最后一项
		}
		if (mode == MODE_PULL_UP_TO_REFRESH || mode == MODE_BOTH) {
			...
			lv.addFooterView(frame, null, false); // 禁止点击最后一项
		}
